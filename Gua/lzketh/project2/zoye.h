...
template<class T> void _print(T arg) {
    cout << arg << " ";
}
...
//
string lowercase1(const string &s) {
     // 这里是两个字符串, 包含了大写字母和小写字母
    // 用 const 修饰是因为它们并不会被修改
    const string lower = "abcdefghijklmnopqrstuvwxyz";
    const string upper = "ABCDEFGHIJKLMNOPQRSTUVWXYZ";
...
// 实现步骤
//     1. 参考作业 3
string uppercase1(const string &s) {
    // 这里是两个字符串, 包含了大写字母和小写字母
    // 用 const 修饰是因为它们并不会被修改
    const string lower = "abcdefghijklmnopqrstuvwxyz";
    const string upper = "ABCDEFGHIJKLMNOPQRSTUVWXYZ";
...
string encode2(const string &s, int shift) {
    const string lower = "abcdefghijklmnopqrstuvwxyz";
    // 初始化一个空字符串
    string result = "";
    size_t i = 0;
...
string encode3(const string &s, int shift) {
    const string lower = "abcdefghijklmnopqrstuvwxyz";
    // 初始化一个空字符串
    string result = "";
    size_t i = 0;
